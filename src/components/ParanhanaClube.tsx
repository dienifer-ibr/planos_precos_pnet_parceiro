  ...
  return (
    <section className="min-h-screen bg-gradient-purple relative overflow-hidden flex items-center justify-center px-4 py-16">
      ...
      <img
        src={LogoFundo}
        alt="Logo de fundo"
        className="absolute inset-0 w-full object-cover opacity-100 lg:top-48 lg:left-80"
      ...
      <div className="relative z-10 flex flex-col items-center">
        <img
          ...
          alt="Decorativa"
          className="w-64 md:w-96 relative -top-4 md:-top-16 right-20 lg:w-80 lg:right-96 lg:top-40"
        />
        <h1 className="text-white text-5xl md:text-6xl font-semibold text-end -mb-24 md:mb-6 leading-tight relative -top-36 left-14 lg:left-80 lg:-mb-8">
          Vantagens <br />
          <span className="text-6xl md:text-6xl font-bold">Exclusivas</span>
        </h1>
        <p className="text-white text-initial mb-5 text-xl px-8 relative lg:left-96 lg:-top-8">
