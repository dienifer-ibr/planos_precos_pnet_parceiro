    ...
    return (
        ...
        >
            ...
            <div className="absolute top-40 left-1/3 transform -translate-x-1/4">
                <img src={LogoParanhanaLivros} alt="ParanhanaNet" className="w-96 lg:w-96 lg:relative lg:-left-48" />
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
                <div className="absolute left-1/2 transform -translate-x-1/2">
                    <img
                        src={CelularLivros}
                        alt="Celular Livros"
                        className="h-auto object-center w-80 lg:w-96 lg:relative lg:-right-96"
                    />
                </div>
                <div className="mt-[400px] w-[90%] max-w-4xl px-4 md:px-6 text-center lg:relative lg:-left-60 lg:-top-60 lg:max-w-3xl">
                    <p className="text-xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl font-semibold">
